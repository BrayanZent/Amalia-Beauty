...
1. Los servicios pasan de una lista plana de 6 opciones a **3 servicios base + adicionales condicionales**.
...
El precio total (base + adicionales marcados) se muestra antes de confirmar.
